...
public class Main {
    ...
    private static void setupScene(Scene scene){
        ...
        scene.createPlane(new Vec3(10, 0, 0), new Vec3(-1, 0, 0), new Lambert(new RgbColor(0f,.8f,0f),new RgbColor(.5f,.5f,0f))); //Right
        ...
        scene.createPlane(new Vec3(0, -10, 0), new Vec3(0, 1, 0), new Lambert(new RgbColor(.9f,.9f,.9f),new RgbColor(.5f,.5f,.5f))); //Bottom
        scene.createPlane(new Vec3(0, 0, -10), new Vec3(0, 0, 1), new Lambert(new RgbColor(.8f,.8f,.0f),new RgbColor(.5f,.5f,.0f))); //Back
        ...
        */
        ...
        float a =200;
        scene.createSphere(new Vec3(4, -6, -4), 2f, new Phong(new RgbColor(.1f,.1f,.1f),new RgbColor(.5f,.5f,.5f), new RgbColor(.5f,.5f,.5f), 3, 0f, a)); //white
        scene.createSphere(new Vec3(-6, -6, -6), 2f, new Phong(new RgbColor(.1f,.1f,.35f),new RgbColor(0,0,1f),new RgbColor(.25f,.5f,.7f), 5, 0f, a)); //blue
        scene.createSphere(new Vec3(5, 0, -1f), 1f, new Phong(new RgbColor(.1f,.35f,.1f),new RgbColor(0,1,0f),new RgbColor(.25f,.5f,.7f), 5, 0f, a)); //green
    }
